          ...
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Este treino é uma <strong>sugestão personalizada</strong> gerada por IA com base no seu perfil. 
                Não substitui orientação de profissionais qualificados. Consulte um educador físico ou médico 
